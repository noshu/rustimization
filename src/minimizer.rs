...
impl<'a> Funcmin<'a>{
    ...
    pub fn new(xvec:&'a mut Vec<f64>,func:&'a Fn(&Vec<f64>)->f64,gd:&'a Fn(&Vec<f64>)->Vec<f64>,m:&'a str)->Self{
            //creating Funcmin struct
            Funcmin{x:xvec,f:func,g:gd,tol:1.0e-7,max_iter:10000,verbose:false,method:m}
    }
